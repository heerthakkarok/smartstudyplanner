...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (errParam === 'google_config_missing') {
      ...
      setError('Google sign-in was canceled or access was denied.');
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full glass-card rounded-3xl p-8 border border-slate-800 space-y-6 shadow-2xl animate-fade-in">
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-400 text-xs">Enter your credentials to access your study planner</p>
        </div>
